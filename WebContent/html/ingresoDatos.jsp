            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="/prototipoWEB/html/dashboard.jsp"><i class="fa fa-bar-chart"></i> Dashboard </a>
    ...
    <div class="panel-body">
        ...
        <div class="row">
        	...
        	<div class="col-md-3 col-md-offset-3">Enter IDs: IDs must be separated by commas. (xxxx,xxxx,xxxx)
								<input required="" type="text" name="ids" class="form-control">
			</div>
        	<div class="col-md-3">Enter the repository:<br><br>
								<input required="" type="text" name="domain" class="form-control"><br>
			</div>
