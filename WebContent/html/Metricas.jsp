...
<head>
  ...
  <link href="<%=request.getContextPath()%>/build/css/custom.min.css" rel="stylesheet">
    <link href="<%=request.getContextPath()%>/build/css/table.css" rel="stylesheet">
</head>
<style> 
          ...
          <div class="panel panel-default">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                <h2>Completeness</h2>
                  <br>
                  <iframe  scrolling="no" style="border-width:0px;" src="http://172.30.4.42:8081/api/rest/public/process/completness?&amp;width=350&amp;height=400" width="350" height="400"></iframe>
              		Percentage of complete cells and percentage of complete rows.
              </div>
              <div class="col-md-3">
                 <h2>Traceability</h2>
                  <br>
                  <iframe  scrolling="no" style="border-width:0px;" src="http://172.30.4.42:8081/api/rest/public/process/traceability?&amp;width=350&amp;height=400" width="350" height="400"></iframe>
					Percentage of complete data in the repository, data of creation and update.
              </div>
               <div class="col-md-3">
                 <h2>Compliance</h2>
                  <br>
                  <iframe  scrolling="no"  style="border-width:0px;" src="http://172.30.4.42:8081/api/rest/public/process/compliance?&amp;width=350&amp;height=400" width="350" height="400"></iframe>
...
<script>
  ...
  $('.links').click(function(){
    ...
    $('.grafico1').append('<iframe scrolling="no" style="border-width:0px;" src="http://172.30.4.42:8081/api/rest/public/process/traceability2?parametroid='+$(this).children().html()+'&amp;width=400&amp;height=300" width="400" height="300"></iframe>');
    $('.grafico2').append('<iframe scrolling="no" style="border-width:0px;" src="http://172.30.4.42:8081/api/rest/public/process/completness2?parametroid='+$(this).children().html()+'&amp;width=400&amp;height=300" width="400" height="300"></iframe>');
    $('.grafico3').append('<iframe scrolling="no" style="border-width:0px;" src="http://172.30.4.42:8081/api/rest/public/process/compliance2?parametroid='+$(this).children().html()+'&amp;width=400&amp;height=300" width="400" height="300"></iframe>');
    $('#myModal').modal("show");
