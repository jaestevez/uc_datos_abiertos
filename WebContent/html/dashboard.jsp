					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="panel panel-default">
								<div class="panel-heading">SECOP II</div>
								<div class="panel-body">
									<div class="col-sm-4" style="height: 200px; background: blue;"></div>
									<div class="col-sm-4" style="height: 200px; background: red;"></div>
									<div class="col-sm-4" style="height: 200px; background: green;"></div>
									<div class="col-sm-4" style="height: 200px; background: green;"></div>
									<div class="col-sm-4" style="height: 200px; background: blue;"></div>
									<div class="col-sm-4" style="height: 200px; background: red;"></div>
								</div>
