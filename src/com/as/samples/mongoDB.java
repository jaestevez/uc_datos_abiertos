	...
	public void Insertar(String collectionDB, String json,String token) throws JSONException{
		...
		public void InsertarTokens(String json,String token) throws IOException, JSONException{
			 ...
			 for(int i = 0; i < jsonarr.length(); i++){
				...
				updateDocument.append("$set", new BasicDBObject().append("egms", db.eval("obtenerEGMS('"+token+"')")));
				BasicDBObject searchQuery2 = new BasicDBObject().append("id", token);
				System.out.println("ingrese el EGMS");
