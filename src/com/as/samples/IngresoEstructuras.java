	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(valestruc.validacion(al)){
				...
				request.getSession().setAttribute("mensaje", "This structure exist into prototype.");
				System.out.println("3");
			}else{
				System.out.println("4");
				insertar.insertarEstructura(ids,dominio);
				System.out.println("5");
				request.getSession().setAttribute("mensaje", "Structure saved correctly!");
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
			System.out.println(e);
			e.printStackTrace();
			request.getSession().setAttribute("mensaje", "This structure does not exist at repository: "+dominio);
